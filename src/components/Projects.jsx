    ...
    <section id="projects" className="py-20 bg-gray-900 text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Project 1 */}
          <div className="bg-gray-800 p-4 rounded shadow-md flex flex-col">
            ...
            <p className="text-gray-300 text-sm mb-4">Website portfolio pribadi menggunakan React dan TailwindCSS.</p>
            <div className="mt-auto flex justify-center gap-3">
              <a href="#" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition text-sm">
                Live Demo
              </a>
              <a href="https://github.com/Riss27/farisdev" className="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600 transition text-sm">
                GitHub
              </a>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 rounded shadow-md flex flex-col">
            ...
            <p className="text-gray-300 text-sm mb-4">Aplikasi to-do list sederhana menggunakan React hooks dan local storage.</p>
            <div className="mt-auto flex justify-center gap-3">
              <a href="#" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition text-sm">
                Live Demo
              </a>
              <a href="#" className="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600 transition text-sm">
                GitHub
              </a>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 rounded shadow-md flex flex-col">
            ...
            <p className="text-gray-300 text-sm mb-4">Aplikasi cuaca real-time menggunakan API dan fetch data dari OpenWeather.</p>
            <div className="mt-auto flex justify-center gap-3">
              <a href="#" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition text-sm">
                Live Demo
              </a>
